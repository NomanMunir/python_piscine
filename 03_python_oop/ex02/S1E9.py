...
class Character(ABC):
    ...
    This class defines the basic structure and behavior that all
    characters must implement. It cannot be instantiated directly.
    """
    ...
    def die(self):
        ...
        how a character dies and changes their alive status.
        """
        pass
